namespace Chimera.Library.HotKeys
{
	partial class ScrollableHotKeysPanel
	{
		...
		{
			this.hotKeyPanel0 = new Chimera.Library.HotKeys.HotKeyPanel();
			this.hotKeyPanel1 = new Chimera.Library.HotKeys.HotKeyPanel();
			this.hotKeyPanel2 = new Chimera.Library.HotKeys.HotKeyPanel();
			this.hotKeyPanel3 = new Chimera.Library.HotKeys.HotKeyPanel();
			this.hotKeyPanel4 = new Chimera.Library.HotKeys.HotKeyPanel();
			this.hotKeyPanel5 = new Chimera.Library.HotKeys.HotKeyPanel();
			this.hotKeyPanel6 = new Chimera.Library.HotKeys.HotKeyPanel();
			this.hotKeyPanel7 = new Chimera.Library.HotKeys.HotKeyPanel();
			this.hotKeyPanel8 = new Chimera.Library.HotKeys.HotKeyPanel();
			this.hotKeyPanel9 = new Chimera.Library.HotKeys.HotKeyPanel();
			this.vScrollBar = new System.Windows.Forms.VScrollBar();
			this.SuspendLayout();
			// 
			// hotKeyPanel0
			// 
			this.hotKeyPanel0.Description = "Description";
			...
			// hotKeyPanel1
			// 
			this.hotKeyPanel1.Description = "Description";
			...
			// hotKeyPanel2
			// 
			this.hotKeyPanel2.Description = "Description";
			...
			// hotKeyPanel3
			// 
			this.hotKeyPanel3.Description = "Description";
			...
			// hotKeyPanel4
			// 
			this.hotKeyPanel4.Description = "Description";
			...
			// hotKeyPanel5
			// 
			this.hotKeyPanel5.Description = "Description";
			...
			// hotKeyPanel6
			// 
			this.hotKeyPanel6.Description = "Description";
			...
			// hotKeyPanel7
			// 
			this.hotKeyPanel7.Description = "Description";
			...
			// hotKeyPanel8
			// 
			this.hotKeyPanel8.Description = "Description";
			...
			// hotKeyPanel9
			// 
			this.hotKeyPanel9.Description = "Description";
