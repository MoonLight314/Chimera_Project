...
namespace Chimera.Library.Settings
{
	using System;
	...
	/// <summary>
	/// A setting that has an unsigned integer value
	/// </summary>
	class UIntSetting
	{
		...
		/// <summary>
		/// Initialises a new instance of the <see cref="UIntSetting" /> class.
		/// </summary>
		...
		/// <summary>
		/// Gets or sets the value of the unsigned integer setting
		/// </summary>
		public uint Value
		{
			get
